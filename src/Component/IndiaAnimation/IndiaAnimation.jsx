...
const IndiaAnimation = () => {
    ...
    return (
        <div className='w-[100%] flex overflow-hidden px-[60px]'>

            <div className="relative flex items-center justify-center h-[500px] w-[80%] ">
                <Swiper
                ...
                >
                    ...
                    <SwiperSlide className="flex items-center justify-center">
                        <div>
                            <h1 className='text-[#158567] text-[21px] mb-[10px] leading-7 font-bold'>Sectors In India</h1>
                            <h2 className='text-black text-[30px] leading-[37px] font-bold mb-[11px]'>Textiles & Apparel</h2>
                            <p className='text-black text-[20px] font-medium mb-[12px]'>7 PM-MITRA Parks announced</p>
                            <p className='text-black text-[15px] leading-7 font-normal'>India is among the world's largest producers of textiles and apparel. Domestic Textile and apparel industry contributes 2.3% to India’s GDP and accounts for 13% of industrial production and…</p>
                            <div className='flex gap-[40px] py-[20px]'>
                                <div className='text-center max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#2</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Cotton producer globally</p>
                                </div>
                                <div className='text-center  max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#2</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Share in total employment</p>
                                </div>
                                <div className='text-center  max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#2</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Worth agricultural and processed food products exported</p>
                                </div>
                            </div>
                            <div className='flex gap-[40px] items-center'>
                                <div>
                                    <div className='border-[#F30F4B] border  px-[15px] py-[12px] flex items-center rounded-[6px] bg-[#F30F4B] cursor-pointer'>
                                        <span className='uppercase text-[16px] font-semibold text-white'>more on the sector</span>
                                    </div>
                                </div>
                                <div className='flex gap-[10px] '>
                                    <div className='border rounded-full bg-white p-1 cursor-pointer'>
                                        <Image
                                            src={"/Rajat_Gupta.jpg"}
                                            width={52}
                                            height={52}
                                    ...
                                    <div className='cursor-pointer'>
                                        <span className='text-black'>Sector Expert</span>
                                        <h2 className='text-[#F30F4B] text-[18px] font-semibold'>Kritika Singh</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <SwiperSlide className="flex items-center justify-center">
                        <div>
                            <h1 className='text-[#158567] text-[21px] mb-[10px] leading-7 font-bold'>Sectors In India</h1>
                            <h2 className='text-black text-[30px] leading-[37px] font-bold mb-[11px]'>Retail & E-commerce</h2>
                            <p className='text-black text-[20px] font-medium mb-[12px]'>7 PM-MITRA Parks announced</p>
                            <p className='text-black text-[15px] leading-7 font-normal'>India is among the world's largest producers of textiles and apparel. Domestic Textile and apparel industry contributes 2.3% to India’s GDP and accounts for 13% of industrial production and…</p>
                            <div className='flex gap-[40px] py-[20px]'>
                                <div className='text-center max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#21</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Cotton producer globally</p>
                                </div>
                                <div className='text-center  max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#202</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Share in total employment</p>
                                </div>
                                <div className='text-center  max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#26</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Worth agricultural and processed food products exported</p>
                                </div>
                            </div>
                            <div className='flex gap-[40px] '>
                                <div className='border-[#F30F4B] border  px-[15px] flex items-center rounded-[6px] bg-[#F30F4B] cursor-pointer'>
                                    <span className='uppercase text-[16px] font-semibold text-white'>more on the sector</span>
                                </div>
                                <div className='flex gap-[10px] '>
                                    <div className='border rounded-full bg-white p-1 cursor-pointer'>
                    ...
                    <SwiperSlide className="flex items-center justify-center">
                        <div>
                            <h1 className='text-[#158567] text-[21px] mb-[10px] leading-7 font-bold'>Sectors In India</h1>
                            <h2 className='text-black text-[30px] leading-[37px] font-bold mb-[11px]'>Pharmaceuticals</h2>
                            <p className='text-black text-[20px] font-medium mb-[12px]'>7 PM-MITRA Parks announced</p>
                            <p className='text-black text-[15px] leading-7 font-normal'>India is among the world's largest producers of textiles and apparel. Domestic Textile and apparel industry contributes 2.3% to India’s GDP and accounts for 13% of industrial production and…</p>
                            <div className='flex gap-[40px] py-[20px]'>
                                <div className='text-center max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#500</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Cotton producer globally</p>
                                </div>
                                <div className='text-center  max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#100</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Share in total employment</p>
                                </div>
                                <div className='text-center  max-w-[100px]'>
                                    <span className='text-black text-[28px] font-bold leading-6 mb-[5px]'>#10</span>
                                    <p className='text-black text-[12px] font-normal leading-4'>Worth agricultural and processed food products exported</p>
                                </div>
                            </div>
                            <div className='flex gap-[40px] '>
            ...
            <button className="absolute right-[25px] top-[35%] rotate-90 border bg-white p-2 rounded-full" onClick={() => rotateSVG("left")}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="w-6 h-6">
                    <path d="M15 19l-7-7 7-7" stroke="black" stroke-width="2" />
                </svg>
            </button>

            <button className="absolute right-[25px] top-[42%] rotate-90 border  bg-white p-2 rounded-full" onClick={() => rotateSVG("right")}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="w-6 h-6">
